	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							...
							<div class="actions">
								<a href="javascript:createNewUser();" class="btn btn-default btn-circle">
						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="sysusers_mobile">
									</td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="sysusers_email">
									</td>
									<td>
				...
				<form action="<%=basePath%>sysusersmanagement/showsysusersinfo.do" id="frmShowInfo" name="frmShowInfo" method="POST">
...
<script>
     jQuery(document).ready(function() {    
		...
		TableAjax.init("<%=basePath%>sysusersmanagement/initsysuserstable.do");
