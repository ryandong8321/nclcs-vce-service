	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet light">
						<div class="portlet-title">
							...
							<div class="actions">
								<a href="javascript:createNewNotification();" class="btn btn-default btn-circle">
				...
				<form action="<%=basePath%>sysnotificationmanagement/showsysnotificationinfo.do" id="frmShowInfo" name="frmShowInfo" method="POST">
					<input type="hidden" id="notificationId" name="notificationId" value=""/>
				</form>
				<form action="<%=basePath%>sysnotificationmanagement/deletemultiplesysnotification.do" id="frmDeleteInfo" name="frmDeleteInfo" method="POST">
					<input type="hidden" id="deleteIds" name="deleteIds" value=""/>
				</form>
				<form action="<%=basePath%>sysnotificationmanagement/sendsysnotification.do" id="frmSendNotification" name="frmSendNotification" method="POST">
					<input type="hidden" id="sendNotificationId" name="sendNotificationId" value=""/>
				</form>
			</div>
			<!-- END PAGE CONTENT-->
		</div>
...
<script>
     jQuery(document).ready(function() {    
		...
		TableAjax.init("<%=basePath%>sysnotificationmanagement/initsysnotificationtable.do");
	...
	function sendNotification(uid){
		$("#sendNotificationId").val(uid);
   	 	$("#frmSendNotification").submit();
	}
