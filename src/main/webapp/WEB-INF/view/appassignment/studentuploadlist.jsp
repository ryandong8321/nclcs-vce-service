					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">上传作业</span>
...
<script>
     jQuery(document).ready(function() {    
		...
		TableAjax.init("<%=basePath%>appassignmentstudentmanagement/inituploadassignmentlist.do");
     ...
     function deleteSeletedAssignment(){
    	 ...
    	 if(JSON.stringify(selections)=="[]"){
    		 showMessage("请选择要收回的作业.");
    		 return;
    	 }
    	 bootbox.confirm("<font size='3'>作业一旦收回将<font color='red'>不可恢复</font>，请确认!</br><font color='red'>注意</font>：只能收回教师未下载的作业，如果您选择的作业中包含教师已下载的作业，操作可能将无法完成.</font>", function (result){
			if (result==true){
