	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">下载作业</span>
				...
				<form action="<%=basePath%>appassignmentstudentmanagement/showstudentassignment.do" id="frmDownloadInfo" name="frmDownloadInfo" method="POST">
					<input type="hidden" id="sid" name="sid" value=""/>
				</form>
				<%-- 
				<form action="<%=basePath%>appassignmentstudentmanagement/showuploadassignmentinfo.do" id="frmShowInfo" name="frmShowInfo" method="POST">
					<input type="hidden" id="uploadAssignmentId" name="uploadAssignmentId" value=""/>
				</form>
				<form action="<%=basePath%>appassignmentstudentmanagement/deletemultipleassignment.do" id="frmDeleteInfo" name="frmDeleteInfo" method="POST">
...
<script>
     jQuery(document).ready(function() {    
		...
		TableAjax.init("<%=basePath%>appassignmentstudentmanagement/initdownloadassignmentlist.do");
