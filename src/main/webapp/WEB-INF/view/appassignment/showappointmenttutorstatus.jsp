					...
					<div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
						<div class="portlet light bordered form-fit">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="<%=basePath%>appassignmenttutormanagement/appointmenttotutor.do" Method="POST" class="form-horizontal form-bordered form-label-stripped" id="frmappointmenttutor">
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" name="assignmentName" placeholder="作业名称" class="form-control" id="assignmentName" value="${assignment.assignmentName }" readonly="readonly"/>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3">代审教师<span class="required">*</span></label>
											<div class="col-md-9">
												<input type="text" name="uploadTime" placeholder="代审教师" class="form-control" id="uploadTime" value="${assignment.assignmentToTutor.targetTutor.chineseName }" readonly="readonly"/>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3">学生姓名<span class="required">*</span></label>
											<div class="col-md-9">
												<input type="text" name="studentName" placeholder="学生姓名" class="form-control" id="studentName" value="${assignment.student.chineseName }" readonly="readonly"/>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3">学生所在校区<span class="required">*</span></label>
											<div class="col-md-9">
												<input type="text" name="campusName" placeholder="所在校区" class="form-control" id="campusName" value="${assignment.student.vceSchoolName }" readonly="readonly"/>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3">学生所在班级<span class="required">*</span></label>
											<div class="col-md-9">
												<input type="text" name="className" placeholder="所在班级" class="form-control" id="className" value="${assignment.student.vceClassName }" readonly="readonly"/>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3">上传时间<span class="required">*</span></label>
											<div class="col-md-9">
												<input type="text" name="uploadTime" placeholder="上传时间" class="form-control" id="uploadTime" value="${assignment.assignmentToTutor.uploadTime }" readonly="readonly"/>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3">下载时间<span class="required">*</span></label>
											<div class="col-md-9">
												<input type="text" name="downloadTime" placeholder="下载时间" class="form-control" id="downloadTime" value="${assignment.assignmentToTutor.downloadTime }" readonly="readonly"/>
											</div>
										</div>
									</div>
									<div class="form-actions">
										<div class="row">
											<div class="col-md-offset-3 col-md-9">
												...
												<button type="button" class="btn default" onclick="javascript:doCancelAction();">返回</button>
											</div>
										</div>
									</div>
...
jQuery(document).ready(function() {    
   // initiate layout and plugins
    ...
    $.ajax({
        ...
        url: "<%=basePath%>appassignmenttutormanagement/findalltutor.do",
        data: "",
        dataType: 'json',
