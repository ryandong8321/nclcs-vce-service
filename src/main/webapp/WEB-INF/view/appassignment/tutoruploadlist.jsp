	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">上传已审作业</span>
				...
				<form action="<%=basePath%>appassignmenttutormanagement/showuploadassignmentinfo.do" id="frmShowInfo" name="frmShowInfo" method="POST">
					<input type="hidden" id="uploadAssignmentId" name="uploadAssignmentId" value=""/>
				</form>
				<form action="<%=basePath%>appassignmenttutormanagement/deletemultipleappointmenttostudent.do" id="frmDeleteInfo" name="frmDeleteInfo" method="POST">
...
<script>
     jQuery(document).ready(function() {    
		...
		TableAjax.init("<%=basePath%>appassignmenttutormanagement/inituploadassignmentlist.do");
