					...
					<div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
						<div class="portlet light bordered form-fit">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="<%=basePath%>appassignmenttutormanagement/saveuploadassignmentinfo.do" 
									...
									<div class="form-body">
										...
										<div class="form-group">
											<label class="control-label col-md-3">选择学生<span class="required">*</span></label>
											<div class="col-md-9">
												<select class="js-states form-control" id="toStudentId" name="toStudentId"></select>
											</div>
										</div>
										<div class="form-group">
									...
									<input type="hidden" name="studentId" value="${uploadassignment.targetStudent.id }" id="studentId" />
								</form>
...
jQuery(document).ready(function() {    
   ...
   if ($("#uploadAssignmentId").val()&&$("#uploadAssignmentId").val()!=""){
	   ...
	   $("#toStudentId").attr("disabled",true);
	   $("#div_can_handle").hide();
   ...
   $.ajax({
       ...
       url: "<%=basePath%>appassignmenttutormanagement/findallstudents.do",
       data: "{'studentId' : '"+$("#studentId").val()+"'}",
       dataType: 'json',
       success: function(result) {
    	   toStudentData=result.data;
       }
   });
   $toStudent.select2({
		data:toStudentData,
   ...
   if (!$("#uploadAssignmentId").val()){
	   $toStudent.val(null).trigger("change");
   }
...
function modifyInfo(){
   	...
   	$("#toStudentId").attr("disabled",false);
...
function doCancelAction(){
	window.location="<%=basePath%>appassignmenttutormanagement/uploadassignmentlist.do";
}
