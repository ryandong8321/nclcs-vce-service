					...
					<div class="tabbable tabbable-custom tabbable-noborder tabbable-reversed">
						<div class="portlet light bordered form-fit">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="<%=basePath%>appassignmentstudentmanagement/saveuploadassignmentinfo.do" 
									...
									<div class="form-body">
										...
										<div class="form-group">
											<label class="control-label col-md-3">教师姓名<span class="required">*</span></label>
											<div class="col-md-9">
												<input type="text" name="tutorName" placeholder="教师姓名" class="form-control" id="tutorName" value="${tutorname }" disabled/>
											</div>
										</div>
										<div class="form-group">
								...
								<form action="<%=basePath%>appassignmentstudentmanagement/.do" Method="POST" id="frmdeleteinfo">
...
function doCancelAction(){
	window.location="<%=basePath%>appassignmentstudentmanagement/uploadassignmentlist.do";
}
