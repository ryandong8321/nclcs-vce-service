	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				...
				<form action="<%=basePath%>appstudentsinfomanagement/showstudentssorceinfo.do" id="frmShowInfo" name="frmShowInfo" method="POST">
...
<script>
     jQuery(document).ready(function() {    
		...
		TableAjax.init("<%=basePath%>appstudentsinfomanagement/initscoretable.do");
