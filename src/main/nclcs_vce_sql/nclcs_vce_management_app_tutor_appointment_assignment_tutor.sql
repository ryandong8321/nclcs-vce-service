...
CREATE TABLE `app_tutor_appointment_assignment_tutor` (
  ...
  `appointment_tutor_student_id` int(11) DEFAULT NULL,
  ...
  `appointment_tutor_assignment_file_name` varchar(128) COLLATE utf8_bin NOT NULL,
  `appointment_tutor_assignment_original_upload_id` int(11) DEFAULT NULL,
  ...
  KEY `FK_APP_TUTOR_APPOINTMENT_ASSIGNMENT_TUTOR_ORIGINAL_UPLOAD_I_idx` (`appointment_tutor_assignment_original_upload_id`),
  ...
  CONSTRAINT `FK_APP_TUTOR_APPOINTMENT_ASSIGNMENT_TUTOR_ORIGINAL_UPLOAD_ID` FOREIGN KEY (`appointment_tutor_assignment_original_upload_id`) REFERENCES `app_student_upload_assignment` (`upload_assignment_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
